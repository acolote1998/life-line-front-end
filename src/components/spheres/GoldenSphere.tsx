const GoldenSphere = (props) => (
  ...
  >
    <path
      ...
      style={{
        fill: "#e1b900", // base dorada más viva
      }}
    />
    <ellipse
      cx={128}
    ...
    <ellipse
      ...
      ry={97}
      style={{
        fill: "#ffcf33", // dorado claro brillante
      }}
    />
    <path
      fillRule="evenodd"
      ...
      style={{
        fill: "#ffe066", // reflejo dorado suave
      }}
    />
    <path
      fillRule="evenodd"
      ...
      style={{
        fill: "#ffdb4d", // dorado suave y claro
      }}
    />
    <ellipse
      cx={128}
