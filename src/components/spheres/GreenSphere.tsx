const GreenSphere = (props: React.SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    <path
      ...
      style={{
        fill: "#1e7e34", // base más oscura tipo success
      }}
    />
    <ellipse
      cx={128}
    ...
    <ellipse
      ...
      ry={97}
      style={{
        fill: "#34d058", // verde claro vibrante
      }}
    />
    <path
      fillRule="evenodd"
      ...
      style={{
        fill: "#7fffd4", // aqua verde suave tipo highlight
      }}
    />
    <path
      fillRule="evenodd"
      ...
      style={{
        fill: "#a8f5b1", // verde pastel brillante
      }}
    />
    <ellipse
      cx={128}
      ...
      ry={47}
      style={{
        fill: "#b9f6ca", // highlight brillante
      }}
    />
    <ellipse
      cx={128}
