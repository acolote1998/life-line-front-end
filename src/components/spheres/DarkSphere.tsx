const DarkSphere = (props: React.SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    <path
      ...
      style={{
        fill: "#4d4d4d", // gris medio para luces
      }}
    />
    <path
      fillRule="evenodd"
      ...
      style={{
        fill: "#666666", // más claro para dar volumen
      }}
    />
    <ellipse
      cx={128}
